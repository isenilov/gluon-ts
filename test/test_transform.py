...
from gluonts.transform import GaussianCopula, gaussian_copula_forward_transform
...
def test_cdf():
            ...
            data_iter=[
                {
                    ...
                    f'past_{transform.FieldName.OBSERVED_VALUES}': past_observed_target,
                }
            ],
            freq='1D',
            one_dim_target=False,
    ...
    t = transform.Chain(
        trans=[
            GaussianCopula(
                target_field=transform.FieldName.TARGET,
                observed_values_field=transform.FieldName.OBSERVED_VALUES,
    ...
    for u in t(iter(ds), is_train=False):
        ...
        back_transformed = gaussian_copula_forward_transform(u, fake_output)
