...
from gluonts.dataset.repository._think_locally_act_globally import (
    generate_glo_dataset,
)
...
dataset_recipes = OrderedDict(
    {
        ...
        "traffic-glo": partial(
            generate_glo_dataset, dataset_name="traffic-glo"
        ),
        "electricity-glo": partial(
            generate_glo_dataset, dataset_name="electricity-glo"
        ),
        "m4_hourly": partial(
            generate_m4_dataset,
            m4_freq="Hourly",
...
def get_dataset(
    ...
    path: Union[Path, str] = default_dataset_path,
) -> TrainDatasets:
    """
    Parameters
    ----------
